    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Haya Rozenberg uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '24fd8b64-7948-4dec-b014-092976f5bace',
                    name: data.name || '',
                    email: data.email || '',
